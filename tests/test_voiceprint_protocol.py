...
from fusion.challenge_response import VOICE_THR, assess, digits_of, gen_challenge
...
class TestChallengeResponse:
    ...
    def test_digits_of(self):
        # 跟读转写提取数字串（语音数字词归一由 ASR ITN 完成后的输入）
        assert digits_of("1357") == "1357"
        assert digits_of("念一遍 2 4 6 8") == "2468"
        assert digits_of("全凭记忆") == ""
        assert digits_of("") == ""
