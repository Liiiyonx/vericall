...
| 数据源 | 真/伪 | 本地状态 | 可用性 |
|---|---|---|---|
| aishell1（真） | 纯真 | ✅ **59 说话人 20,329 条**（S0002-S0060，hf-mirror 2026-09-06） | **合规中文真样本池（可入训练，CFAD 真同源）** |
...
**结论（2026-09-06 终版）**：中文域增量训练数据侧**已完全闭环**——真 aishell1 20,329 + 伪 FMFCC 17.6k。
