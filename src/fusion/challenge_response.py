...
def digits_of(transcript: str) -> str:
    """从跟读转写中提取数字串（"五八二三"→"5823" 等语音数字词归一由上层 ASR ITN 完成）。"""
    return "".join(ch for ch in str(transcript or "") if ch.isdigit())
